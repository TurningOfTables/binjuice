...
var bd = []binData{
	{Name: "Food", FriendlyName: "Useless Food", ImagePath: "food_bin.png", Freq: 1, Collected: false},
	{Name: "Recycling", FriendlyName: "Recycling", ImagePath: "recycling_bin.png", Freq: 2, Collected: false},
	{Name: "Grey", FriendlyName: "Waste", ImagePath: "grey_bin.png", Freq: 3, Collected: false},
	{Name: "Green", FriendlyName: "Garden", ImagePath: "green_bin.png", Freq: 2, Collected: false},
}
...
func NextCollectionDate(t time.Time) time.Time {
	...
	// It's already Thursday so return date
	...
	// If nearest Thursday is in the past, add a week
	if ncd.Unix() <= t.Unix() {
...
// currentWeekYear returns the current week and year, or the following week and year if it's after COLLECTIONDAY
